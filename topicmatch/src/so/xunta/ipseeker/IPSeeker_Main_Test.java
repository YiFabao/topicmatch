...
public class IPSeeker_Main_Test {
  ...
  public static void main(String arg[]){  
                  //指定纯真数据库的文件名，所在文件夹  
          IPSeeker ip=new IPSeeker("QQWry.Dat",LocalContext.getIPFileInstallFolder());  
  ...
  System.out.println(ip.getIPLocation("127.0.0.1").getCountry()+":"+ip.getIPLocation("42.121.136.225").getCountry());  
